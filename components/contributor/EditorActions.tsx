      ...
      {isApproved && (
        <div className="space-y-2">
          ...
          {isScheduledFuture ? (
            ...
            <p className="text-xs text-emerald-400 font-semibold">✓ Approved — ready to publish</p>
          )}
          {/* Publish Now — works for both scheduled and unscheduled approved submissions */}
          <button
